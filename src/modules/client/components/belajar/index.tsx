...
const steps: StepType[] = [
	{
		selector: "#list-bab-link",
		content: "Klik di sini untuk melihat daftar bab yang tersedia",
		position: "bottom",
	},
	{
		selector: "#lesson-0",
		content: "Klik di sini untuk memulai pelajaran pertama kamu!",
	},
	{
		selector: "#lesson-1",
		content: "Klik di sini untuk memulai quiz pertama kamu!",
	},
];
